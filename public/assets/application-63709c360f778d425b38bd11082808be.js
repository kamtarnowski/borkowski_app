...
(function() {
  $(function() {
    return $('#business_method_content').keyup(function() {
      return $('#show_view').html($(this).val());
    });
  });
...
(function() {
  $(function() {
    return $('#company_datum_content').keyup(function() {
      return $('#show_view').html($(this).val());
    });
  });
...
(function() {
  $(function() {
    return $('#home_page_content').keyup(function() {
      return $('#show_view').html($(this).val());
    });
  });
...
(function() {
  $(function() {
    ...
    return $(".owl-carousel_foot").owlCarousel({
      autoPlay: 7000,
      slideSpeed: 300,
      paginationSpeed: 400,
      singleItem: true
